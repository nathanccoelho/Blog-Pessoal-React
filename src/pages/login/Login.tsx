...
function Login() {
    ...
    function login(e: ChangeEvent<HTMLFormElement>) {
        ...
        return (
        <>
            <div className="min-h-screen flex items-center justify-center  py-12 px-4 sm:px-6 lg:px-8 bg-gray-500 bg-no-repeat bg-cover relative "
                ...
                <div className="max-w-md w-full  px-10 pb-2 bg-white rounded-xl z-10">
                    <div className="text-center">
                        <h2 className="mt-5 mb-2 text-3xl font-bold text-gray-900">
                            Iniciar sessão
                        </h2>
                    </div>
                    ...
                    <form className="mt-8 space-y-6" action="#" method="POST">
                        ...
                        <div className="mt-8 content-center">
                            ...
                            <input className="w-full content-center text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="Digite sua senha"
